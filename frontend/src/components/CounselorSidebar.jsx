...
import CounselorTopNav from "./CounselorTopNav";

const TOPNAV_CLAIM_KEY = "__counselor_topnav_claimed__";

/**
 * Backward-compatible export: pages still import CounselorSidebar.
...
export default function CounselorSidebar() {
  ...
  return createPortal(<CounselorTopNav />, document.body);
}
